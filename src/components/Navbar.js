    ...
    <header>
      <div className="flex">
        <div className="bg-blue-500 w-1/3 p-3 flex items-center px-5">
          <span className="text-white font-bold text-[13px] md:text-[18px] company">Shakir Enterprises</span>
        </div>
      ...
      <nav className="flex justify-center md:justify-between md:container items-center
       ...
       text-white mx-auto text-[12px] md:text-[15px] font-bold">
        ...
        <li><NavLink className="link font-bold " to="/login">Login</NavLink></li>  
        <li><NavLink className="link font-bold " to="/signup">Sign Up</NavLink></li>  
        </ul>
